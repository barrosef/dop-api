...
from app.coreclient.gen.dop.v1 import cost_pb2 as _cost_pb2
...
class TurnRouting(_message.Message):
    __slots__ = ("task_kind", "model_class", "model", "effort", "effort_applied", "reason", "from_agent_card")
    ...
    def __init__(self, task_kind: _Optional[str] = ..., model_class: _Optional[str] = ..., model: _Optional[str] = ..., effort: _Optional[str] = ..., effort_applied: _Optional[str] = ..., reason: _Optional[str] = ..., from_agent_card: _Optional[bool] = ...) -> None: ...
...
class TurnUsage(_message.Message):
    ...
    cost_known: bool
    def __init__(self, input_tokens: _Optional[int] = ..., output_tokens: _Optional[int] = ..., cache_read_tokens: _Optional[int] = ..., cache_creation_tokens: _Optional[int] = ..., cost: _Optional[_Union[_common_pb2.Money, _Mapping]] = ..., cache_creation_known: _Optional[bool] = ..., cost_known: _Optional[bool] = ...) -> None: ...

class TurnFinding(_message.Message):
    __slots__ = ("id", "title")
...
class TurnOutcome(_message.Message):
    __slots__ = ("demand", "thread_id", "provider", "routing", "reply", "message_ids", "concluded", "finding", "usage", "context_truncated", "paused", "notice", "budgets", "warnings")
    ...
    paused: bool
    notice: str
    budgets: _containers.RepeatedCompositeFieldContainer[_cost_pb2.Budget]
