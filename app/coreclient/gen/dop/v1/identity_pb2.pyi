...
class CreateAccountRequest(_message.Message):
    __slots__ = ("kind", "handle", "display_name", "legal_id", "idempotency_key")
    KIND_FIELD_NUMBER: _ClassVar[int]
    HANDLE_FIELD_NUMBER: _ClassVar[int]
    DISPLAY_NAME_FIELD_NUMBER: _ClassVar[int]
    LEGAL_ID_FIELD_NUMBER: _ClassVar[int]
...
class ListMembershipsRequest(_message.Message):
    ...
    ACCOUNT_FIELD_NUMBER: _ClassVar[int]
    account: _common_pb2.AccountRef
    def __init__(self, account: _Optional[_Union[_common_pb2.AccountRef, _Mapping]] = ...) -> None: ...
...
class AcceptInviteRequest(_message.Message):
    __slots__ = ("invite_id", "idempotency_key")
    INVITE_ID_FIELD_NUMBER: _ClassVar[int]
    IDEMPOTENCY_KEY_FIELD_NUMBER: _ClassVar[int]
    invite_id: str
    idempotency_key: str
    def __init__(self, invite_id: _Optional[str] = ..., idempotency_key: _Optional[str] = ...) -> None: ...
...
class UpdateMembershipRequest(_message.Message):
    ...
    role: Role
    grants: _containers.RepeatedCompositeFieldContainer[ResourceGrantSpec]
    def __init__(self, membership_id: _Optional[str] = ..., role: _Optional[_Union[Role, str]] = ..., grants: _Optional[_Iterable[_Union[ResourceGrantSpec, _Mapping]]] = ...) -> None: ...
