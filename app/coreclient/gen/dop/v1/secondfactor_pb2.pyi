...
class EnrollSecondFactorRequest(_message.Message):
    __slots__ = ("kind", "label", "destination", "idempotency_key")
    KIND_FIELD_NUMBER: _ClassVar[int]
    LABEL_FIELD_NUMBER: _ClassVar[int]
    ...
    destination: str
    idempotency_key: str
    def __init__(self, kind: _Optional[_Union[SecondFactorKind, str]] = ..., label: _Optional[str] = ..., destination: _Optional[str] = ..., idempotency_key: _Optional[str] = ...) -> None: ...
