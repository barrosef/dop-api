...
class Flow(_message.Message):
    __slots__ = ("id", "name", "description", "version", "owner_scope", "owner_id", "stages")
    ...
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., description: _Optional[str] = ..., version: _Optional[int] = ..., owner_scope: _Optional[str] = ..., owner_id: _Optional[str] = ..., stages: _Optional[_Iterable[_Union[StageSpec, _Mapping]]] = ...) -> None: ...

class StageOrigin(_message.Message):
    __slots__ = ("stage_key", "scope")
    STAGE_KEY_FIELD_NUMBER: _ClassVar[int]
    SCOPE_FIELD_NUMBER: _ClassVar[int]
    stage_key: str
    scope: str
    def __init__(self, stage_key: _Optional[str] = ..., scope: _Optional[str] = ...) -> None: ...

class Provenance(_message.Message):
    __slots__ = ("contributors", "origins", "sentence", "truncated")
    ...
    sentence: str
    truncated: bool
    def __init__(self, contributors: _Optional[_Iterable[str]] = ..., origins: _Optional[_Iterable[_Union[StageOrigin, _Mapping]]] = ..., sentence: _Optional[str] = ..., truncated: _Optional[bool] = ...) -> None: ...

class EffectiveFlow(_message.Message):
    __slots__ = ("flow", "provenance")
    FLOW_FIELD_NUMBER: _ClassVar[int]
    PROVENANCE_FIELD_NUMBER: _ClassVar[int]
    flow: Flow
    provenance: Provenance
    def __init__(self, flow: _Optional[_Union[Flow, _Mapping]] = ..., provenance: _Optional[_Union[Provenance, _Mapping]] = ...) -> None: ...
...
class UpdateFlowRequest(_message.Message):
    ...
    id: str
    flow: Flow
    def __init__(self, id: _Optional[str] = ..., flow: _Optional[_Union[Flow, _Mapping]] = ...) -> None: ...
